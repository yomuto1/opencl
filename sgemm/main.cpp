...
static float sa_a_f32[K * M];
static float sa_b_f32[K * N];
static float sa_alg_c_f32[M * N];
static float sa_ocl_c_f32[M * N];
...
int main(int argc, char ** argv)
{
	...
	for (i_s32 = 0; i_s32 < K * M; ++i_s32)
    {
		sa_a_f32[i_s32] = (i_s32 * 0.32f) - 1000.f;
	}
	for (i_s32 = 0; i_s32 < K * N; ++i_s32)
	{
